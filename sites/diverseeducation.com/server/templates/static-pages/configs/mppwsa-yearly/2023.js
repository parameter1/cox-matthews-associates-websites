module.exports = {
  description: 'Now in its 10th year, Promising Places to Work in Student Affairs (PPWSA) is a national recognition that celebrates student affairs workplaces that are vibrant, diverse, supportive, and committed to staff work-life balance, professional development, and inclusive excellence. PPWSA offers institutional leaders information that can be used to improve practices across their student affairs communities, while serving as a useful tool for employers, career services staff, and job-seekers across the country.',
  ...
  study: '<p>This study was first proposed by Ralph Newell at <i>Diverse: Issues In Higher Education</i> as a possible partnership with the American College Personnel Association (ACPA) in 2011. The ACPA Governing Board motioned for then-director of research and scholarship Dr. Terrell Strayhorn to explore the merit and extent of the project. With input from a volunteer advisory board, the project was recommended to the governing board and approved.</p><p>ACPA and <i>Diverse: Issues In Higher Education</i> commissioned Strayhorn to serve as the project’s principal investigator. In the role, Strayhorn developed the PPWSA survey in consultation with experts on the project’s advisory board. The original survey was pilot tested with a small sample of non-ACPA member institutions; feedback from the pilot test helped to clarify survey items, correct logic sequencing, and determine the utility of our scoring algorithm.</p><p>The purpose of this commissioned study was to examine the extent to which diversity and inclusion permeates aspects of various divisions of student affairs (or equivalent) at participating ACPA-member institutions across the globe including administrative structures, commitments, work environments, and staffing practices.</p>',
