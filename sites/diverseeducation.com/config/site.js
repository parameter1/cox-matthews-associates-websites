...
module.exports = {
  ...
  logos: {
    navbar: {
      src: 'https://img.diverseeducation.com/files/base/diverse/logo.png?h=45&auto=format,compress&q=70',
      srcset: [
        'https://img.diverseeducation.com/files/base/diverse/logo.png?h=90&auto=format,compress&q=70 2x',
      ],
    },
    footer: {
      src: 'https://img.diverseeducation.com/files/base/diverse/logo.png?h=60&auto=format,compress&q=70',
      srcset: [
        'https://img.diverseeducation.com/files/base/diverse/logo.png?h=120&auto=format,compress&q=70 2x',
      ],
    },
  },
  socialMediaLinks: [
