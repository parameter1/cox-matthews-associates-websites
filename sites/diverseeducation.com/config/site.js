...
module.exports = {
  ...
  logos: {
    navbar: {
      src: 'https://img.diverseeducation.com/files/base/diverse/all/image/static/EDULEDGER.png?h=80&auto=format,compress&q=70',
      srcset: [
        'https://img.diverseeducation.com/files/base/diverse/all/image/static/EDULEDGER.png?h=80&auto=format,compress&q=70&dpr=2 2x',
      ],
    },
    footer: {
